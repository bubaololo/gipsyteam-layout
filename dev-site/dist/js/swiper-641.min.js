...
!(function (e, t) {
  ...
  function s(e, t) {
    void 0 === e && (e = {}),
      ...
      Object.keys(t).forEach(function (r) {
        void 0 === e[r]
          ? (e[r] = t[r])
          : i(t[r]) && i(e[r]) && Object.keys(t[r]).length > 0 && s(e[r], t[r]);
      });
  }
  var r = {
    body: {},
    ...
    if ("string" == typeof e) {
      ...
      if (a.indexOf("<") >= 0 && a.indexOf(">") >= 0) {
        ...
        r = (function (e, t) {
          ...
          for (
            var i = [], s = t.querySelectorAll(e), r = 0;
            r < s.length;
            r += 1
          )
            i.push(s[r]);
    ...
    b = {
      ...
      on: function () {
        ...
        function o(e) {
          ...
          if (t) {
            ...
            if ((i.indexOf(e) < 0 && i.unshift(e), m(t).is(r))) n.apply(t, i);
            else
              for (var s = m(t).parents(), a = 0; a < s.length; a += 1)
                m(s[a]).is(r) && n.apply(s[a], i);
          }
        }
        function l(e) {
          ...
          if (r)
            for (d = 0; d < p.length; d += 1) {
              ...
              c.dom7LiveListeners || (c.dom7LiveListeners = {}),
                ...
                c.dom7LiveListeners[v].push({ listener: n, proxyListener: o }),
                c.addEventListener(v, o, a);
            }
          else
            for (d = 0; d < p.length; d += 1) {
              var f = p[d];
      ...
      offset: function () {
        if (this.length > 0) {
          ...
          return { top: s.top + d - a, left: s.left + p - l };
        }
        return null;
      },
      css: function (e, t) {
  ...
  function x() {
    for (
      ...
      if (null != i)
        for (
          var s = Object.keys(Object(i)), r = 0, n = s.length;
          r < n;
          r += 1
        ) {
          var a = s[r],
        ...
        (C = (function (e) {
          ...
          return (
            !u &&
              ...
              (h = !1)),
            p && !f && ((a.os = "android"), (a.android = !0)),
            (u || v || c) && ((a.os = "ios"), (a.ios = !0)),
            a
          );
        })(e)),
      C
          ...
          if (!(!r.isTouchEvent && "button" in d && d.button > 0))
            if (!r.isTouched || !r.isMoved)
              if (
                ...
                t.allowClick = !0;
              else if (!a.swipeHandler || p.closest(a.swipeHandler)[0]) {
                (l.currentX =
                ...
                if (!v || !(u <= f || u >= s.innerWidth - f)) {
                  if (
                    ...
                    var g = h && t.allowTouchMove && a.touchStartPreventDefault;
      ...
      if (!s.isTouchEvent || "touchmove" === l.type) {
        ...
        if (!i.allowTouchMove)
          return (
            ...
            void (
              s.isTouched &&
              (x(a, { startX: p, startY: u, currentX: p, currentY: u }),
              (s.touchStartTime = y()))
            )
          );
          ...
          if (
            ...
            if (
              ...
              if (
                ...
                h > 0 && s.currentTranslate > i.minTranslate()
                  ? ((g = !1),
                    r.resistance &&
                      (s.currentTranslate =
                        i.minTranslate() -
                        1 +
                        Math.pow(-i.minTranslate() + s.startTranslate + h, C)))
                  : h < 0 &&
                    ...
                    r.resistance &&
                      (s.currentTranslate =
                        i.maxTranslate() +
                        1 -
                        Math.pow(i.maxTranslate() - s.startTranslate - h, C))),
  ...
  function B(e) {
    ...
    if (
      ...
      if (s.freeMode) {
          ...
          if (i.velocities.length > 1) {
            ...
            (t.velocity = h / m),
              ...
              Math.abs(t.velocity) < s.freeModeMinimumVelocity &&
                (t.velocity = 0),
              (m > 150 || y() - v.time > 300) && (t.velocity = 0);
          } else t.velocity = 0;
        ...
        for (
          var O = 0, A = t.slidesSizesGrid[0], z = 0;
          z < o.length;
          z += z < s.slidesPerGroupSkip ? 1 : s.slidesPerGroup
        ) {
          var I = z < s.slidesPerGroupSkip - 1 ? 1 : s.slidesPerGroup;
          void 0 !== o[z + I]
            ? p >= o[z] && p < o[z + I] && ((O = z), (A = o[z + I] - o[z]))
            : p >= o[z] && ((O = z), (A = o[o.length - 1] - o[o.length - 2]));
        }
        var B = (p - o[O]) / A,
        ...
        if (c > s.longSwipesMs) {
          ...
          "next" === t.swipeDirection &&
            (B >= s.longSwipesRatio ? t.slideTo(O + D) : t.slideTo(O)),
            "prev" === t.swipeDirection &&
              (B > 1 - s.longSwipesRatio ? t.slideTo(O + D) : t.slideTo(O));
        } else {
  ...
  var F = {
    ...
    V = {
          ...
          return i.eventsListeners
            ? (e.split(" ").forEach(function (e) {
                void 0 === t
                  ? (i.eventsListeners[e] = [])
                  : i.eventsListeners[e] &&
                    i.eventsListeners[e].forEach(function (s, r) {
                      (s === t ||
      ...
      update: {
          ...
          if (void 0 !== r) {
            ...
            for (
              ...
              if (i.slidesPerColumn > 1) {
                ...
                if ("row" === i.slidesPerColumnFill && i.slidesPerGroup > 1) {
                  var G = Math.floor(
                    ...
                    N = A - i.slidesPerColumn * i.slidesPerGroup * G,
                    $ =
                      0 === G
                        ? i.slidesPerGroup
                        : Math.min(
                  ...
                  (I =
                    (B =
                      N - (D = Math.floor(N / $)) * $ + G * i.slidesPerGroup) +
                    (D * E) / k),
                    z.css({
              ...
              if ("none" !== z.css("display")) {
                if ("auto" === i.slidesPerView) {
                  var H = t.getComputedStyle(z[0], null),
                    F = z[0].style.transform,
                    V = z[0].style.webkitTransform;
                  if (
                    (F && (z[0].style.transform = "none"),
                    V && (z[0].style.webkitTransform = "none"),
                    i.roundLengths)
                  )
                    M = e.isHorizontal() ? z.outerWidth(!0) : z.outerHeight(!0);
                  else if (e.isHorizontal()) {
                    var j = parseFloat(H.getPropertyValue("width") || 0),
                    ...
                    if (X && "border-box" === X) M = j + R + q;
                    else {
                      var Y = z[0],
                        U = Y.clientWidth;
                      M = j + _ + W + R + q + (Y.offsetWidth - U);
                    }
                  } else {
                    ...
                    if (te && "border-box" === te) M = K + Z + ee;
                    else {
                      var ie = z[0],
                        se = ie.clientHeight;
                      M = K + J + Q + Z + ee + (ie.offsetHeight - se);
                    }
                  }
                  F && (z[0].style.transform = F),
                    V && (z[0].style.webkitTransform = V),
                  ...
                  (M = (r - (i.slidesPerView - 1) * b) / i.slidesPerView),
                    ...
                    p[A] &&
                      (e.isHorizontal()
                        ? (p[A].style.width = M + "px")
                        : (p[A].style.height = M + "px"));
            ...
            if (
              ...
              i.setWrapperSize &&
                (e.isHorizontal()
                  ? s.css({ width: e.virtualSize + i.spaceBetween + "px" })
                  : s.css({ height: e.virtualSize + i.spaceBetween + "px" })),
              i.slidesPerColumn > 1 &&
                ((e.virtualSize = (M + i.spaceBetween) * E),
                (e.virtualSize =
              ...
              for (var re = 0; re < c.length; re += 1) {
                ...
                i.roundLengths && (ne = Math.floor(ne)),
                  c[re] < e.virtualSize + c[0] && P.push(ne);
              }
              c = P;
            }
            if (!i.centeredSlides) {
              ...
              for (var ae = 0; ae < c.length; ae += 1) {
                var oe = c[ae];
                i.roundLengths && (oe = Math.floor(oe)),
                  c[ae] <= e.virtualSize - r && P.push(oe);
              }
              (c = P),
            ...
            if (
              ...
              0 !== i.spaceBetween &&
                (e.isHorizontal()
                  ? n
                    ? p.filter(h).css({ marginLeft: b + "px" })
                    : p.filter(h).css({ marginRight: b + "px" })
                  : p.filter(h).css({ marginBottom: b + "px" })),
            ...
            x(e, { slides: p, snapGrid: c, slidesGrid: v, slidesSizesGrid: f }),
        ...
        updateProgress: function (e) {
          ...
          0 === r
            ? ((n = 0), (a = !0), (o = !0))
            : ((a = (n = (e - t.minTranslate()) / r) <= 0), (o = n >= 1)),
            x(t, { progress: n, isBeginning: a, isEnd: o }),
        ...
        updateActiveIndex: function (e) {
          ...
          if (n.indexOf(s) >= 0) t = n.indexOf(s);
            ...
            var c = Math.min(a.slidesPerGroupSkip, p);
            t = c + Math.floor((p - c) / a.slidesPerGroup);
          }
          if ((t >= n.length && (t = n.length - 1), p !== o)) {
            var v = parseInt(
      ...
      slide: {
        slideTo: function (e, t, i, s) {
          ...
          if (
            ...
            return (
              ...
              "reset" !== m && (n.transitionStart(i, m), n.transitionEnd(i, m)),
              !1
            );
          if (o.cssMode) {
            var w,
              b = n.isHorizontal(),
              T = -g;
            if ((c && (T = v.scrollWidth - v.offsetWidth - T), 0 === t))
              v[b ? "scrollLeft" : "scrollTop"] = T;
            else if (v.scrollTo)
              v.scrollTo(
                (((w = {})[b ? "left" : "top"] = T), (w.behavior = "smooth"), w)
              );
            else v[b ? "scrollLeft" : "scrollTop"] = T;
            return !0;
          }
          return (
            0 === t
        ...
        slideNext: function (e, t, i) {
          ...
          var s = this,
            r = s.params,
            n = s.animating,
            a = s.activeIndex < r.slidesPerGroupSkip ? 1 : r.slidesPerGroup;
          if (r.loop) {
        ...
        slidePrev: function (e, t, i) {
          ...
          var p,
            ...
            v = (a[c.indexOf(u)], a[c.indexOf(u) - 1]);
          return (
            void 0 === v &&
              r.cssMode &&
            ...
            void 0 !== v && (p = o.indexOf(v)) < 0 && (p = s.activeIndex - 1),
            s.slideTo(p, e, t, i)
          );
        },
        ...
        slideToClosest: function (e, t, i, s) {
          ...
          if (l >= r.snapGrid[o]) {
            var d = r.snapGrid[o];
            l - d > (r.snapGrid[o + 1] - d) * s &&
              (n += r.params.slidesPerGroup);
          } else {
            var p = r.snapGrid[o - 1];
            l - p <= (r.snapGrid[o] - p) * s && (n -= r.params.slidesPerGroup);
          }
          return (
            (n = Math.max(n, 0)),
      ...
      loop: {
        loopCreate: function () {
          ...
          for (var u = 0; u < p.length; u += 1)
            s.append(m(p[u].cloneNode(!0)).addClass(i.slideDuplicateClass));
          for (var c = d.length - 1; c >= 0; c -= 1)
            s.prepend(m(d[c].cloneNode(!0)).addClass(i.slideDuplicateClass));
        },
        loopFix: function () {
          var e = this;
        ...
        attachEvents: function () {
          ...
          if (!l.touch && l.pointerEvents)
            ...
            if (l.touch) {
              ...
              r.addEventListener(s.start, e.onTouchStart, p),
                r.addEventListener(
                  s.move,
                  e.onTouchMove,
                  l.passiveListener ? { passive: !1, capture: d } : d
                ),
                r.addEventListener(s.end, e.onTouchEnd, p),
                s.cancel && r.addEventListener(s.cancel, e.onTouchEnd, p),
        ...
        detachEvents: function () {
          ...
          if (!l.touch && l.pointerEvents)
            ...
            if (l.touch) {
              ...
              r.removeEventListener(s.start, e.onTouchStart, p),
                r.removeEventListener(s.move, e.onTouchMove, d),
                r.removeEventListener(s.end, e.onTouchEnd, p),
                s.cancel && r.removeEventListener(s.cancel, e.onTouchEnd, p);
            }
            ((i.simulateTouch && !o.ios && !o.android) ||
              (i.simulateTouch && !l.touch && o.ios)) &&
            ...
            if (l && e.currentBreakpoint !== l) {
              ...
              u && !c
                ...
                : !u &&
                  ...
                  e.emitContainerClasses());
              var v = p.direction && p.direction !== n.direction,
                f = n.loop && (p.slidesPerView !== n.slidesPerView || v);
    ...
    _ = (function () {
      function t() {
        for (
          var e, i, s = arguments.length, r = new Array(s), n = 0;
          n < s;
          n++
        )
          r[n] = arguments[n];
        ...
        var a = this;
        (a.support = M()),
          (a.device = P({ userAgent: i.userAgent })),
          (a.browser = k()),
          (a.eventsListeners = {}),
        ...
        if ((e = l[0])) {
          ...
          return (
            ...
            e && e.shadowRoot && e.shadowRoot.querySelector
              ? ((p = m(
                  e.shadowRoot.querySelector("." + a.params.wrapperClass)
                )).children = function (e) {
                  return l.children(e);
                })
      ...
      return (
        ...
        (n.slidesPerViewDynamic = function () {
          ...
          if (t.centeredSlides) {
            ...
            for (var p = n - 1; p >= 0; p -= 1)
              i[p] &&
                !o &&
                ((a += 1), (l += i[p].swiperSlideSize) > r && (o = !0));
          } else
        ...
        (t.installModule = function (e) {
          ...
          var i = e.name || Object.keys(t.prototype.modules).length + "_" + y();
      ...
      update: function () {
        ...
        if (
          ...
          if (
            ...
            if (
              ...
              p.each(function (e) {
                var t = m(e),
                  r = t.index();
                r === s && t.addClass(i.bulletActiveClass),
                  i.dynamicBullets &&
                    (r >= o &&
                      r <= l &&
            ...
            if (i.dynamicBullets) {
              var C = Math.min(p.length, i.dynamicMainBullets + 4),
                w =
          ...
          "custom" === i.type && i.renderCustom
            ? (n.html(i.renderCustom(e, s + 1, a)),
              e.emit("paginationRender", n[0]))
            : e.emit("paginationUpdate", n[0]),
            n[
              e.params.watchOverflow && e.isLocked ? "addClass" : "removeClass"
            ](i.lockClass);
        }
