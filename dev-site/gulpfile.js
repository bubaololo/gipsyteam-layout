...
const paths = {
  ...
  //
  // sassStandaloneFile: 'scss/standalone/sv-school.scss',
  sassStandaloneFile: 'scss/standalone/marketplace/marketplace.scss',
  // sassStandaloneFile: 'scss/standalone/traffic/traffic.scss',
...
// current sprite name
const spriteName = 'traffic-sprite';
